...
namespace ProjectFocuser.Util
{
    public class ExtensionSettingsHelper
    {
        public static string SettingsFolderPaths => Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.MyDocuments), @"Visual Studio 2017\Settings\ProjectFocuser\");

        public static string SettingsFileNameWithExtensions => "ProjectFocuser.Settings.json";
